    ...
    <section className="relative w-full h-screen overflow-hidden bg-noir-gradient">
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-16 reveal-animation">
          ...
          <Button variant="default" size="lg" className="group bg-gradient-to-r from-neon-cyan to-electric-500 hover:from-electric-500 hover:to-neon-cyan shadow-neon hover:shadow-neon-lg transition-all duration-300">
            <Calendar className="mr-2 group-hover:animate-pulse" size={24} />
            Book a Lesson
          </Button>
          
          <Button variant="outline" size="lg" className="group border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-noir-950 transition-all duration-300">
